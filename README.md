...
# Estratégia de Robustez: Mocking de UI
...
Adicionei dentro do arquivo Hooks uma sessão para que tenha como optar se deseja visualizar o navegador ou não. "private const bool" true = sim / false = não
